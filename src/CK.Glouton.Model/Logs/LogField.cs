...
namespace CK.Glouton.Model.Logs
{
    public class LogField
    {
        ...
        public const string DETAILS = "DetailedInfo";
        ...
        public const string EXCEPTION_TYPE_NAME = "ExceptionTypeName";
        public const string AGGREGATE_EXCEPTION = "AggregateException";
    }
}
